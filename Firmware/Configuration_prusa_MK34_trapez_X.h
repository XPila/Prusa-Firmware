...
#define HOMING_FEEDRATE {3000, 3000, 1000, 0}  // set the homing speeds (mm/min) // 3000 is also valid for stallGuard homing. Valid range: 2200 - 3000
...
#define DEFAULT_MAX_FEEDRATE                {100, 100, 40, 120}      // (mm/sec)   max feedrate (M203)
#define DEFAULT_MAX_FEEDRATE_SILENT         {100, 100, 40, 120}      // (mm/sec)   max feedrate (M203), silent mode

#define DEFAULT_MAX_ACCELERATION            {1000, 1000, 400, 5000}  // (mm/sec^2) max acceleration (M201)
#define DEFAULT_MAX_ACCELERATION_SILENT     {960, 960, 400, 5000}    // (mm/sec^2) max acceleration (M201), silent mode


#define DEFAULT_ACCELERATION          1000   // X, Y, Z and E max acceleration in mm/s^2 for printing moves (M204S)
#define DEFAULT_RETRACT_ACCELERATION  1000   // X, Y, Z and E max acceleration in mm/s^2 for retracts (M204T)
...
#define NORMAL_MAX_FEEDRATE_XY   100  // max feedrate in mm/s
...
//#define DEBUG_ESTEP_DUP_PIN 21   //duplicate y-step output to pin 21 (SCL on P3)
...
#define TMC2130_USTEPS_X    4         // microstep resolution for X axis
#define TMC2130_USTEPS_Y    4         // microstep resolution for Y axis
...
#define TMC2130_CURRENTS_H {35, 35, 52, 23}  // default holding currents for all axes
#define TMC2130_CURRENTS_R {35, 35, 52, 23}  // default running currents for all axes
...
//#define MESH_MAX_X 175
//#define MESH_MIN_Y 25
//#define MESH_MAX_Y 175

#define MESH_MIN_X 10
#define MESH_MAX_X MESH_MIN_X + 180
#define MESH_MIN_Y 10
#define MESH_MAX_Y MESH_MIN_Y + 170
