...
// Printer name
#define CUSTOM_MENDEL_NAME "Prusa MKX34B3"
...
#define DEFAULT_MAX_FEEDRATE                {200, 200, 40, 120}      // (mm/sec)   max feedrate (M203)
...
#define TMC2130_USTEPS_Y    16        // microstep resolution for Y axes
...
#define TMC2130_CURRENTS_H {29, 29, 52, 29}  // default holding currents for all axes
#define TMC2130_CURRENTS_R {29, 29, 52, 29}  // default running currents for all axes
