...
// Printer name
#define CUSTOM_MENDEL_NAME "Prusa MKX34T3"
...
#define TMC2130_CURRENTS_H {35, 35, 52, 29}  // default holding currents for all axes
#define TMC2130_CURRENTS_R {35, 35, 52, 29}  // default running currents for all axes
